...
directory <- "Collect/PTU_Group/ANI_all_plasmid"
...
write_csv(combined_data, "Collect/PTU_Group/intermediate_data_for_plasmid_ANI_plot.csv")
...
ggsave("Results/PTU_Group/pairwise_ANI_of_plasmid.pdf", p, width = 10, height = length(file_list) * 0.3, units = "in", dpi = 300, limitsize = FALSE)
